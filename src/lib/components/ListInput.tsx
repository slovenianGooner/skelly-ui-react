...
import {XButton, XListInputItem} from "../index.js";
...
type ListInputProps = {
    ...
    emptyValue: any,
    children: (props: { item: any, setItem: (item: any) => void }) => any,
    className?: string,
    collapsed?: boolean,
    addNewButton?: any,
}

export default function ListInput({value, onChange, emptyValue, children, className = '', collapsed = false, addNewButton}: ListInputProps) {
