...
type ListInputItemProps = {
    ...
    title: string,
    collapsed?: boolean,
    children: (props: { item: any, setItem: (key: string, newValue: any) => void }) => JSX.Element
}

export default function ListInputItem({item, onChange, onRemove, canMoveUp, onMoveUp, canMoveDown, onMoveDown, title, collapsed = false, children}: ListInputItemProps) {
